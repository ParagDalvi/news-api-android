...
public class ScienceFragment extends Fragment {
    ...
    private static final String URL = "https://newsapi.org/v2/top-headlines?category=science&apiKey=aa4130e9df3a4ac6adb48e4f78d26edf&country=in";
    ...
    private LinearLayout layoutWithTryAgian;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        layoutWithTryAgian = view.findViewById(R.id.layoutWithTryAgain);

        layoutWithTryAgian.setVisibility(View.GONE);
    ...
    private void loadRecyclerViewData() {
        ...
        {
            progressBar.setVisibility(View.GONE);
            layoutWithTryAgian.setVisibility(View.VISIBLE);
        }
    }
