...
public class SportsFragment extends Fragment {
    ...
    private final static String URL_SPORTS = "https://newsapi.org/v2/top-headlines?category=sports&apiKey=aa4130e9df3a4ac6adb48e4f78d26edf&country=in";
    ...
    private void loadRecyclerViewData() {
        ...
        {
            layoutWithTryAgain.setVisibility(View.GONE);
            StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_SPORTS,
