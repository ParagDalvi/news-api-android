...
public class BollywoodFragment extends Fragment {
    private static final String URL = "https://newsapi.org/v2/top-headlines?category=entertainment&apiKey=aa4130e9df3a4ac6adb48e4f78d26edf&country=in";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bollywood_fragment, container,false);
