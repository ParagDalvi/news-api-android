...
public class HealthFragment extends Fragment {
    ...
    private String healthURL = "http://newsapi.org/v2/top-headlines?apiKey=aa4130e9df3a4ac6adb48e4f78d26edf&category=health&country=in";
    ...
    private void loadRecyclerViewData() {
        ...
        {
            layoutWithTryAgain.setVisibility(View.GONE);
            StringRequest stringRequest = new StringRequest(Request.Method.GET, healthURL,
